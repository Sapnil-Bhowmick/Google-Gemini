...
const SinglePromptMoreHist = ({ item, index }) => {
    ...
    return (
        ...
        >
                    ...
                    edit ?
                        ...
                        (
                            <input
                                ...
                                onKeyDown={(e) => Save_Edit(e, index + ElementsToSlice)} />
                        )
                        :
            ...
            <div className='edit-del-div'>
                ...
                <div className='dot-div' onClick={() => Edit(index + ElementsToSlice)} >
...
export default SinglePromptMoreHist